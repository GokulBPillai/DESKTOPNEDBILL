...
{
    public partial class FrmProductSelectList : Form
    {
     ...
     (
        ...
        private void TxtProductName_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                var stkList = (from stk in cMPDBContext.Stock
                               join bth in cMPDBContext.Batch on stk.StockId equals bth.StockId
                               where stk.Status == true &&
                               stk.StockName.Contains(TxtProductName.Text)
                               select new
                               {
                                   stk.StockId,
                                   bth.BatchId,
        ...
        private void FrmProductSelectList_KeyDown(object sender, KeyEventArgs e)
        {
