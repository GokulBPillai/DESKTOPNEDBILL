...
{
    public partial class FrmPrintCompositeSalesReturn : Form
    {
        public FrmPrintCompositeSalesReturn()
        {
            InitializeComponent();
        }

        private void FrmPrintCompositeSalesReturn_Load(object sender, EventArgs e)
        {
        ...
        private void FrmPrintCompositeSalesReturn_KeyDown(object sender, KeyEventArgs e)
        {
