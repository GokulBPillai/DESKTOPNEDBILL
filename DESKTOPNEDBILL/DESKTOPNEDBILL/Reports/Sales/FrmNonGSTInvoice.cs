...
{
    public partial class FrmNonGSTInvoice : Form
    {
        public FrmNonGSTInvoice()
        {
            InitializeComponent();
        }

        private void FrmNonGSTInvoice_Load(object sender, EventArgs e)
        {
        ...
        private void FrmNonGSTInvoice_KeyDown(object sender, KeyEventArgs e)
        {
