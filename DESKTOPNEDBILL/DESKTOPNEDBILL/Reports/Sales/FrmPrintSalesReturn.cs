...
{
    public partial class FrmPrintSalesReturn : Form
    {
        public FrmPrintSalesReturn()
        {
            InitializeComponent();
        }

        private void FrmPrintSalesReturn_Load(object sender, EventArgs e)
        {
        ...
        private void FrmPrintSalesReturn_KeyDown(object sender, KeyEventArgs e)
        {
